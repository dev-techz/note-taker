...
export const SignUp = (props) => {
    ...
    const host = "https://fine-gray-katydid.cyclic.app/";
    ...
    return (
        <div>
            <div className='text-center bg-info rounded text-white py-2 px-2'><h3 className='px-1 mx-1  d-inline-block'>Create an account to use Note-Taker...</h3></div>
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    <label className="form-label">Name</label>
                    <input type="password" className="form-control" name="name" id="name" onChange={onChange} />
                </div>
                <div className="mb-3">
